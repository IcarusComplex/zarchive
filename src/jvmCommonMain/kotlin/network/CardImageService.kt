...
class CardImageService : AutoCloseable {
    ...
    // Per-user cache so it works regardless of the app's install location (a packaged build's
    // working dir may be read-only). Desktop: ~/.zarchive/images/<sha1>.jpg. Android: app-private
    // storage. See data.PlatformPaths.
    private val dir = PlatformPaths.imagesDir
